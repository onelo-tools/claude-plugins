...
//
//   try {
//     const file = await onelo.monitor.track('doc_import', async () => {
//       const picked = await pickDocument()
//       if (!picked) throw new Error('cancelled')   // dismissed, or permission denied
//       return picked
//     }, { meta: { source: 'picker' } })
//   } catch {
//     // already recorded as ok:false with its duration — leave the screen as-is
//   }
//
